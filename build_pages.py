...
SERVICES = [
    ...
    ('Snow Removal', 'Get Winter Service', 'Dependable winter service for homes, businesses, and properties that need safe access when Northwest Ohio weather hits.', ['Driveways', 'Walkways', 'Commercial lots', 'Ice management', 'Winter response'], 'assets/real-commercial.webp', 'contact.html'),
]
SERVICE_GROUPS = [
...
<section class="section services-section homepage-services">
  <div class="container section-heading">
    ...
    <p>Service cards now sit after the homeowner has picked a problem and seen the transformation story, so they feel like answers instead of a directory.</p>
  </div>
